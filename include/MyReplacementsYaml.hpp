//===-- MyReplacementsYaml.hpp -- Serialiazation for Replacements ---*- C++ -*-===//
//
...
/// replacements. This is a modified version based on the original file
/// "clang/Tooling/ReplacementsYaml.h" to support storing absolute file path
///
//===----------------------------------------------------------------------===//
...
template <> struct MappingTraits<clang::tooling::Replacement> {
  ...
  struct NormalizedReplacement {
    ...
    NormalizedReplacement(const IO &, const clang::tooling::Replacement &R)
        : FilePath(clang::tooling::getAbsolutePath(R.getFilePath())),
          Offset(R.getOffset()),
          Length(R.getLength()),
